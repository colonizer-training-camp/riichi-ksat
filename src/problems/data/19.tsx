  ...
  content: {
    ko: (
      <>
        ...
        <Box>
          <B>HN:</B> 이게 말이 돼? 오늘 작혼에서 ‘역만 기회’만 두 번 봤는데 한
          번도 역만 화료를 못 했어.
          <br />
          <B>MAXFLOW:</B> 그래도 첫 번째 ‘역만 기회’는 <GG /> 화료했잖아.
          <br />
          <B>CCW:</B> 그 상황에서 1판 <NN />
          부로 화료한 건 조금 안타깝네.
          <br />
          <B>shiftpsh:</B> 두 번째 ‘역만 기회’ 상황에서는 샤보 대기로도, 양면
          대기로도 화료할 수 있었겠구나.
        </Box>
        <p>
        ...
        <Viewㄱㄴㄷ>
          ...
          <li>
            두 번째 ‘역만 기회’ 상황에서 자패로 화료할 경우 역만 이상의 화료만이
            가능하다.
          </li>
        </Viewㄱㄴㄷ>
      </>
