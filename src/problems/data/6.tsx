...
const PROBLEM: Problem = {
  ...
  content: {
    ...
    ja: (
      <>
        <p>下の文章は四人リーチ麻雀に関する資料である。</p>
        <Box가나다>
          <li>
            リーチ麻雀の牌は全部で34種類あり、合計で
            <GG />
            枚の牌を使用する。
          </li>
          <li>
            リーチ麻雀では王牌14枚を残す。このうち嶺上牌4枚を除いた10枚は、誰もいかなる方法でも取ることができない。
          </li>
        </Box가나다>
        <p>
        ...
        <Viewㄱㄴㄷ>
          ...
          <li>
            {나}
            にもかかわらず、対局中の「槓（カン）」の発声によって王牌の枚数が永久に減少することがある。
          </li>
          <li>
            対局中に発声が一切なく荒牌平局となった場合、牌山の最後の牌は南家が取る。
          </li>
        </Viewㄱㄴㄷ>
      </>
    ),
